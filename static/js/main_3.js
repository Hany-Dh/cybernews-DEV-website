...
function renderIncidentCard(inc) {
  ...
  card.innerHTML = `
    ...
    <div class="ir-card-actions">
      <button class="ir-card-btn" onclick="selectForPlaybook('${inc.id}',event)" title="Generate AI Playbook for this incident">◈ AI Playbook</button>
